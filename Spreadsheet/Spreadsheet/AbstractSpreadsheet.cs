...
//
//
// Additional comments written by Caden Erickson, for PS4 & PS5
// Last edited: 09/23/22
...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// </summary>
        /// <param name="filename">The name of the file to which to write the JSON representation of the current spreadsheet</param>
        ...
        /// <excpetion cref="InvalidNameException">If the given name is an invalid cell name</excpetion>
        ...
        /// <param name="content">The contents string to set as the cell's contents</param>
        /// <returns>An IList of the nameed cell's dependents</returns>
        ...
        /// <br/>
        /// This method "visits" all the cells that are dependent (directly or indirectly)
        /// on the cell of the given name, adding them to a List which is eventually returned.
        /// The "visiting" is done by what is essentially a depth-first search through the dependents
        /// of the named cell. Each visited cell is checked to see if a CircularException exists between it
        /// and the named cell. If so, a Circular Exception is thrown.
        /// </summary>
        /// <param name="start">The name of the cell at which the entire recursive check has been started</param>
        /// <param name="name">The name of the cell whose dependents are currently being checks</param>
        /// <param name="visited">The set of all the cells who've been "visited" so far</param>
        /// <param name="changed">The list of all the cells thus farthat need to be recalculated</param>
        /// <exception cref="CircularException">If a circular dependency exists</exception>
